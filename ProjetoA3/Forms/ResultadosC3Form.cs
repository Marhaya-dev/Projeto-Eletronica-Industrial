...
{
    public partial class ResultadosC3Form : Form
    {
        public ResultadosC3Form()
        {
            InitializeComponent();
        }

        private void ResultadosC3Form_Load(object sender, EventArgs e)
        {
        ...
        {
            var dados = JsonUtils.Read("DadosC3");
